...
import static com.example.androproject.LoginActivity.LoginStatus;
...
*/
        ...
        String status=sharedpreferences.getString(LoginStatus,"statusKey");

        if (status.equalsIgnoreCase("loggedin"))
        {

            launchIntent = new Intent(SplashActivity.this, FrontpageActivity.class);

        }
        else
        {

            launchIntent = new Intent(SplashActivity.this, RegisterActivity.class);
